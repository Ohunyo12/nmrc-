...
@Component({
  selector: 'app-form-3800b-los',
  templateUrl: './form-3800b-los.component.html',
  //styleUrls: ['./form-3800b-los.component.scss']
})
export class Form3800bLosComponent implements OnInit {
  ...
  ngOnInit() {
   // console.log("the reference number "+this.applicationReferenceNumber);
