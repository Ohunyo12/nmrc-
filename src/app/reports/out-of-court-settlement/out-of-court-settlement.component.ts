...
@Component({
  selector: 'app-out-of-court-settlement',
  templateUrl: './out-of-court-settlement.component.html'
})
export class OutOfCourtSettlementComponent implements OnInit {
  ...
  popoverSeeMore(form) {
    ...
    this.reportServ.GetOutOfCourtSettlementReport(body).subscribe((response: any) => {
