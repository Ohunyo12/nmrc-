...
@Component({
  selector: 'app-payday-loan-allocation',
  templateUrl: './payday-loan-allocation.component.html'
})
export class PaydayLoanAllocationComponent implements OnInit {
  ...
  popoverSeeMore(form) {
    ...
    this.reportServ.GetPaydayLoanRecoveryCollectionReport(body).subscribe((response: any) => {
