...
@Component({
  selector: 'app-recovery-agent-update',
  templateUrl: './recovery-agent-update.component.html'
})
export class RecoveryAgentUpdateComponent implements OnInit {
  ...
  popoverSeeMore(form) {
    ...
    this.reportServ.GetRecoveryAgentUpdateReport(body).subscribe((response: any) => {
