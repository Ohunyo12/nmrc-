...
@Component({
  selector: 'app-user-group-change-report',
  templateUrl: './user-group-change-report.component.html',

})
export class UserGroupChangeReportComponent implements OnInit {
  ...
  displayGeneratedReport() {
    ...
    this.reportServ.GetUserGroupChangeReport(data).subscribe((response: any) => {
