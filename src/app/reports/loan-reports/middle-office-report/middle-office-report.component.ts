...
@Component({
  selector: 'app-middle-office-report',
  templateUrl: './middle-office-report.component.html',

})
export class MiddleOfficeReportComponent implements OnInit {
  ...
  displayGeneratedReport() {
    ...
    this.reportServ.GetMiddleOfficeReport(data).subscribe((response: any) => {
