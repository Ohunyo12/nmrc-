...
@Component({
  selector: 'app-credit-schedule-report',
  templateUrl: './credit-schedule-report.component.html',

})
export class CreditScheduleReportComponent implements OnInit {
  ...
  displayGeneratedReport() {
    ...
    this.reportServ.GetCreditScheduleReport(data).subscribe((response: any) => {
