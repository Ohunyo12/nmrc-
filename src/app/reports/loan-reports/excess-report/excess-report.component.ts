...
@Component({
  selector: 'app-excess-report',
  templateUrl: './excess-report.component.html',

})
export class ExcessReportComponent implements OnInit {
  ...
  popoverSeeMore() {
    if (this.startDate != null && this.endDate != null) {
      ...
      this.reportServ.GetExcessReport(data)
