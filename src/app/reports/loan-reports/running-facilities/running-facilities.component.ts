...
@Component({
  selector: 'app-running-facilities',
  templateUrl: './running-facilities.component.html'
})

export class RunningFacilitiesComponent implements OnInit {
  ...
  popoverSeeMore() {
    ...
    if (this.startDate != null && this.endDate != null) {
      ...
      this.reportServ.getRunningFacilitiesReport(data)
