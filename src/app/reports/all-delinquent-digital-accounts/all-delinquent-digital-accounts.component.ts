...
@Component({
  selector: 'app-all-delinquent-digital-accounts',
  templateUrl: './all-delinquent-digital-accounts.component.html',
  styleUrls: ['./all-delinquent-digital-accounts.component.scss']
})
export class AllDelinquentDigitalAccountsComponent implements OnInit {
  conditions: any[] = [];
  ...
  ngOnInit() {
    this.GetDelinquentDigitalAccounts();
