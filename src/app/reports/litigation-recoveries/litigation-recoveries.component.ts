...
@Component({
  selector: 'app-litigation-recoveries',
  templateUrl: './litigation-recoveries.component.html'
})
export class LitigationRecoveriesComponent implements OnInit {
  ...
  popoverSeeMore(form) {
    ...
    this.reportServ.GetLitigationRecoveriesReport(body).subscribe((response: any) => {
