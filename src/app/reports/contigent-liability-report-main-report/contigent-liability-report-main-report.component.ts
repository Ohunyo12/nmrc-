...
@Component({
  selector: 'app-contigent-liability-report-main-report',
  templateUrl: './contigent-liability-report-main-report.component.html',
  styleUrls: ['./contigent-liability-report-main-report.component.scss']
})


export class ContigentLiabilityReportMainReportComponent  implements OnInit {
  PAGEOPERATION = 6; 
  ...
  popoverSeeMore(form) {
    ...
    this.loadingService.show();
     ...
     var body = {
       ...
       this.reportServ.GetContigentLiabilityReportMain(body).subscribe((response: any) => {
