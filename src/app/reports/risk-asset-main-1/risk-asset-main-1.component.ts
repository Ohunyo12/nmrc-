...
@Component({
  selector: 'app-risk-asset-main-1',
  templateUrl: './risk-asset-main-1.component.html',
  styleUrls: ['./risk-asset-main-1.component.scss']
})


export class RiskAssetMain1Component implements OnInit {
  PAGEOPERATION = 6; 
  ...
  popoverSeeMore(form) {
    ...
    this.loadingService.show();
     ...
     var body = {
       ...
       this.reportServ. GetRiskAssetMain1Report(body).subscribe((response: any) => {
