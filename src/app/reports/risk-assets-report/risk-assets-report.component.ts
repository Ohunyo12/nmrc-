...
@Component({
  selector: 'app-risk-assets-report',
  templateUrl: './risk-assets-report.component.html'
  // styleUrls: ['./risk-assets-report.component.scss']
})
export class RiskAssetsReportComponent implements OnInit {
  PAGEOPERATION = 6; 
  ...
  auditTypeId: any;
  stagingSearch: any;
  riskAssetsReportForm: FormGroup;
  ...
  constructor(private approvalSer: ApprovalService, private loadingService: LoadingService,
    ...
    ngOnInit() {
    this.riskAssetsReportForm = this.fb.group({
  ...
  clearInput() {
    ...
    this.riskAssetsReportForm.setValue({
      misCode: null,
      level:  null,
      runDate: null,
      exposureType:null,
