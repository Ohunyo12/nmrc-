...
@Component({
  selector: 'app-copy-of-risk-asset-main-report',
  templateUrl: './copy-of-risk-asset-main-report.component.html',
  styleUrls: ['./copy-of-risk-asset-main-report.component.scss']
})


export class CopyOfRiskAssetMainReportComponent implements OnInit {
  PAGEOPERATION = 6; 
  ...
  auditTypeId: any;
  stagingSearch: any;
  copyOfRiskMainReportForm: FormGroup;
  ...
  constructor(private approvalSer: ApprovalService, private loadingService: LoadingService,
    ...
    ngOnInit() {
    this.copyOfRiskMainReportForm = this.fb.group({
  ...
  popoverSeeMore(form) {
    ...
    this.loadingService.show();
     ...
     var body = {
       ...
       this.reportServ.GetCopyOfRiskAssetMain(body).subscribe((response: any) => {
  ...
  clearInput() {
    ...
    this.copyOfRiskMainReportForm.setValue({
      misCode: null,
      level:  null,
      runDate: null,
      exposureType:null,
