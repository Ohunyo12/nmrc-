...
@Component({
  selector: 'app-contingent-liability-report-main-1-report',
  templateUrl: './contingent-liability-report-main-1-report.component.html',
  styleUrls: ['./contingent-liability-report-main-1-report.component.scss']
})

export class ContingentLiabilityReportMain1ReportComponent implements OnInit {
  PAGEOPERATION = 6; 
  ...
  auditTypeId: any;
  stagingSearch: any;
  contigentLiabilityMainReportForm: FormGroup;
  ...
  constructor(private approvalSer: ApprovalService, private loadingService: LoadingService,
    ...
    ngOnInit() {
    this.contigentLiabilityMainReportForm = this.fb.group({
  ...
  popoverSeeMore(form) {
    ...
    this.loadingService.show();
     ...
     var body = {
       ...
       this.reportServ.GetContigentLiabilityReportMain1(body).subscribe((response: any) => {
  ...
  clearInput() {
    ...
    this.contigentLiabilityMainReportForm.setValue({
      misCode: null,
      level:  null,
      runDate: null,
      exposureType:null,
