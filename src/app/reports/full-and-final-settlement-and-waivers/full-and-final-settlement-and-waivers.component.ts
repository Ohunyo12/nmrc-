...
@Component({
  selector: 'app-full-and-final-settlement-and-waivers',
  templateUrl: './full-and-final-settlement-and-waivers.component.html'
})
export class FullAndFinalSettlementAndWaiversComponent implements OnInit {
  ...
  popoverSeeMore(form) {
    ...
    this.reportServ.GetFullAndFinalSettlementAndWaiversReport(body).subscribe((response: any) => {
