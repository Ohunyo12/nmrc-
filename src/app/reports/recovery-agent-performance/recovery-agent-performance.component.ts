...
@Component({
  selector: 'app-recovery-agent-performance',
  templateUrl: './recovery-agent-performance.component.html'
})
export class RecoveryAgentPerformanceComponent implements OnInit {
  ...
  popoverSeeMore(form) {
    ...
    this.reportServ.GetRecoveryAgentPerformanceReport(body).subscribe((response: any) => {
