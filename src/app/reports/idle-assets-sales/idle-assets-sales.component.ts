...
@Component({
  selector: 'app-idle-assets-sales',
  templateUrl: './idle-assets-sales.component.html'
})
export class IdleAssetsSalesComponent implements OnInit {
  ...
  popoverSeeMore(form) {
    ...
    this.reportServ.GetIdleAssetsSalesReport(body).subscribe((response: any) => {
