...
@Component({
  selector: 'app-collateral-adequacy',
  templateUrl: './collateral-adequacy.component.html',

})
export class CollateralAdequacyComponent implements OnInit {
  ...
  popoverSeeMore() {
    if (this.startDate != null && this.endDate != null) {
      ...
      this.reportServ.getCollateralAdequacy(data)
