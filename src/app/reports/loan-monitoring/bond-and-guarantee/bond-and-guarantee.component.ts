...
@Component({
  selector: 'app-bond-and-guarantee',
  templateUrl: './bond-and-guarantee.component.html',
})
export class BondAndGuaranteeComponent implements OnInit {
    ...
    popoverSeeMore() {
        ...
        if (this.startDate != null && this.endDate != null) {
           ...
           const data = {
            ...
            this.reportServ.getBondAndGuaranteeReport(data)
