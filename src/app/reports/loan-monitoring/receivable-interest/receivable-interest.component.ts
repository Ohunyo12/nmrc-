...
@Component({
  selector: 'app-receivable-interest',
  templateUrl: './receivable-interest.component.html',
  //styleUrls: ['./receivable-interest.component.scss']
})
export class ReceivableInterestComponent implements OnInit {
  ...
  displayGeneratedReport() {
      ...
      this.reportServ.getReceivedInterest(data).subscribe((response: any) => {
