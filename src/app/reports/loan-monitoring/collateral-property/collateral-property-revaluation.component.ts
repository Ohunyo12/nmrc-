...
@Component({
    templateUrl: 'collateral-property-revaluation.component.html'
})

export class CollateralPropertyRevaluationComponent implements OnInit {
    ...
    displayGeneratedReport() {
        ...
        this.reportServ.getCollateralPropertyRevaluationReport(data).subscribe((response: any) => {
