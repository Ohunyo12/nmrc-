...
@Component({
    templateUrl: 'loan-covenants.component.html'
})

export class LoanCovenantsApproachingDueDateComponent implements OnInit {
    ...
    displayGeneratedReport() {
        ...
        this.reportServ.getCovenantsApproachingDueDateReport(data).subscribe((response: any) => {
