...
@Component({
  selector: 'app-contingents-reoprt',
  templateUrl: './contingents-reoprt.component.html'
})
export class ContingentsReoprtComponent implements OnInit {

    displayTestReport: boolean;
    startDate?: Date; endDate?: Date;reportType:any;
    ...
    popoverSeeMore() {
        ...
        if (this.startDate != null && this.endDate != null) {
           ...
           const data = {
                ...
                reportAllType:this.reportType
            }
            
            this.reportServ.getContingentsReport(data)
