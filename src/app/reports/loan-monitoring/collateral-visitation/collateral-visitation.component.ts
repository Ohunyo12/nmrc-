...
@Component({
  selector: 'app-collateral-visitation',
  templateUrl: './collateral-visitation.component.html',
})
export class CollateralVisitationComponent implements OnInit {
    ...
    popoverSeeMore() {
        ...
        if (this.startDate != null && this.endDate != null) {
           ...
           const data = {
            ...
            this.reportServ.getCollateralVisitationReport(data)
