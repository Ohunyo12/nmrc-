...
@Component({
  selector: 'app-computation-for-external-agents',
  templateUrl: './computation-for-external-agents.component.html'
})
export class ComputationForExternalAgentsComponent implements OnInit {
  ...
  popoverSeeMore(form) {
    ...
    this.reportServ.GetComputationForExternalAgentsReport(body).subscribe((response: any) => {
