...
@Component({
  selector: 'app-collateral-sales',
  templateUrl: './collateral-sales.component.html'
})
export class CollateralSalesComponent implements OnInit {
  ...
  popoverSeeMore(form) {
    ...
    this.reportServ.GetCollateralSalesReport(body).subscribe((response: any) => {
