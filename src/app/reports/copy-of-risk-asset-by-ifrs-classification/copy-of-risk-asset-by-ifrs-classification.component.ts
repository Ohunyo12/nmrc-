...
@Component({
  selector: 'app-copy-of-risk-asset-by-ifrs-classification',
  templateUrl: './copy-of-risk-asset-by-ifrs-classification.component.html',
  styleUrls: ['./copy-of-risk-asset-by-ifrs-classification.component.scss']
})

export class CopyOfRiskAssetByIfrsClassificationComponent implements OnInit {
  PAGEOPERATION = 6; 
  ...
  auditTypeId: any;
  stagingSearch: any;
  CopyOfRiskAssetByIfrsClassificationForm: FormGroup;
  ...
  constructor(private approvalSer: ApprovalService, private loadingService: LoadingService,
    ...
    ngOnInit() {
    this.CopyOfRiskAssetByIfrsClassificationForm = this.fb.group({
  ...
  popoverSeeMore(form) {
    ...
    this.loadingService.show();
     ...
     var body = {
       ...
       this.reportServ.GetCopyOfRiskAssetByIfrsClassification(body).subscribe((response: any) => {
  ...
  clearInput() {
    ...
    this.CopyOfRiskAssetByIfrsClassificationForm.setValue({
      misCode: null,
      level:  null,
      runDate: null,
      exposureType:null,
