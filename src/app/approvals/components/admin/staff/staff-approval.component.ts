...
export class StaffApprovalComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.getAllStaff(); this.getAllApprovalStatus();
    }

    getAllStaff() {
        this.staffService.getStaffAwaitingApprovals().subscribe((response: any) => {
    ...
    goForApproval(formObj) {
        ...
        swal({
            ...
            __this.staffService.approveStaff(bodyObj).subscribe((response: any) => {
