...
@Component({
  selector: 'app-lms-loan-application-cancellation',
  templateUrl: './lms-loan-application-cancellation.component.html',
  // styleUrls: ['./loan-application-cancellation.component.scss']
})
export class LmsLoanApplicationCancellationComponent implements OnInit {
  application: any;
  ...
  getAllLoans() {
    ...
    this.loanService.lmsLoanApplicationcancellation().subscribe((response: any) => {
  ...
  viewLoanDetail(row) {
    ...
    this.loanService.viewLmsLoanApplicationcancellation(data).subscribe((response: any) => {
  ...
  forward() {
    ...
    swal({
      ...
      __this.loanService.GoForLmsLoanApplcationCancellationApproval(data).subscribe((response: any) => {
