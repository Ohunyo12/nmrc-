...
@Component({
  selector: 'app-bulk-recovery-commission-approval',
  templateUrl: './bulk-recovery-commission-approval.component.html'
})
export class BulkRecoveryCommissionApprovalComponent implements OnInit {
    ...
    getBulkRecoveryCommissionAwaitingApproval() {
        this.loadingService.show();
        this.loanOperationService.GetBulkRecoveryCommissionAwaitingApproval().subscribe((response: any) => {
        this.loanOperationApprovalData = response.result;
        this.loadingService.hide();
      });
    }

    getAllLoansRecoveryCommissionByReference(referenceId) {
      this.loanOperationService.getAllLoansRecoveryCommissionByReference(referenceId).subscribe((response: any) => {
    ...
    viewLoanDetails(row, evt) {
        ...
        this.getAllLoansRecoveryCommissionByReference(this.loanSelectedData.referenceId);
        this.getTrail23();
    ...
    goForApproval(formObj) {
        ...
        let bodyObj = {
            ...
            targetId: this.loanSelectedData.loanRecoveryCommissionApprovalId,
        ...
        swal({
            ...
            __this.loanOperationService.sendBulkRecoveryCommissionForApproval(bodyObj).subscribe((response: any) => {
                __this.loadingService.hide();
                if (response.success === true) {
                  __this.loanSelectedData = {};
                    __this.loanSelectedData = {};
                    __this.getBulkRecoveryCommissionAwaitingApproval();
    ...
    getTrail23() {
        this.loadingService.show();
        this.subscriptions.add(
                this.camService.getTrailLms(this.loanSelectedData.loanRecoveryCommissionApprovalId, this.loanSelectedData.operationId).subscribe((response: any) => {
