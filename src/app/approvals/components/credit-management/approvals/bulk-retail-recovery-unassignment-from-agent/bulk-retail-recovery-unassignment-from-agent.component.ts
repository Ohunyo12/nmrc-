...
@Component({
  selector: 'app-bulk-retail-recovery-unassignment-from-agent',
  templateUrl: './bulk-retail-recovery-unassignment-from-agent.component.html'
})
export class BulkRetailRecoveryUnassignmentFromAgentComponent implements OnInit {
    ...
    getBulkRecoveryToAgentAwaitingApproval() {
        this.loadingService.show();
        this.loanOperationService.getBulkUnassignmentRetailRecoveryFromAgentAwaitingApproval().subscribe((response: any) => {
