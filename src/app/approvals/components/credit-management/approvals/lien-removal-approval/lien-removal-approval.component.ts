...
@Component({
  selector: 'app-lien-removal-approval',
  templateUrl: './lien-removal-approval.component.html'
})
export class LienRemovalApprovalComponent implements OnInit {
    ...
    viewLoanDetails(row, evt) {
        ...
        this.getAllLLienRemovalDocuments(this.loanSelectedData.lienRemovalId);
        let dataObj = this.loanSelectedData;
        this.lienRemovalId = this.loanSelectedData.lienRemovalId;
        this.lienRemovalOperationId = this.loanSelectedData.lienRemovalOperationId;
        this.lienReferenceNumber = this.loanSelectedData.lienReferenceNumber;
    ...
    goForApproval(formObj) {
        ...
        let bodyObj = {
            operationId: this.loanSelectedData.lienRemovalOperationId,
            targetId: this.loanSelectedData.lienRemovalId,
        ...
        swal({
            ...
            __this.loanOperationService.sendLienRemovalOperationForApproval(bodyObj).subscribe((response: any) => {
                __this.loadingService.hide();
                if (response.success === true) {
                    __this.loanSelectedData = {};
                    __this.getAllLLienRemovalAwaitingApproval();
    ...
    getTrail23() {
        this.loadingService.show();
        this.subscriptions.add(
                this.camService.getTrailLms(this.lienRemovalId, this.lienRemovalOperationId).subscribe((response: any) => {
