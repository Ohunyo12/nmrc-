...
@Component({
    selector: 'loan-review-drawdown',
    templateUrl: 'loan-review-drawdown.component.html'
})
export class LoanReviewDrawdownComponent implements OnInit, OnDestroy {
    ...
    activeIndex: any;
    jobSourceId: number;
    readonly OPERATION_ID: number = 0;
  ...
  ngOnDestroy(): void {
    ...
    ngOnInit() {
        ...
        this.approvalActionsComponent.isAvailmentPage = false;
    }
    ...
    onApplicationSelected(selected) {        
        ...
        this.lmsApplicationId = this.application.lmsApplicationId,
        this.lmsOperationId = this.application.lmsOperationId,
