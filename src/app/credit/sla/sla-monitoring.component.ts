...
// }
    ...
    reset() {
        ...
        this.getLoanReviewApplications(this.currentLazyLoadEvent.first, this.currentLazyLoadEvent.rows);
    }
    ...
    */
    ...
    onSelectedReviewApplicationChange(): void {
    ...
    updateWorkflowTargetLms() {
        ...
        this.workflowTarget.operationId = this.reviewSelection.operationId;
    ...
    onFacilityChange(id) {
        const x = this.reviewSelection.applicationDetails.find(x => x.loanApplicationDetailId == id);
        if (x == null) { return; }
