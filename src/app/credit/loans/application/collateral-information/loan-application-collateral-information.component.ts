...
@Component({
    selector: 'collateral-template',
    templateUrl: 'loan-application-collateral-information.component.html'
})
export class LoanApplicationCollateralInformationComponent implements OnInit {
    ...
    ngOnInit() {
       ...
       this.getCustomerCollateral(customerId)
    }
    gotoLoanEligibility(){
    ...
    editCustomerCollateral(index) {
        var row = this.customerCollaterals[index];
    ...
    editImmovableProperty() {  //
        this.propertyForm = this.fb.group({
            ...
            perfectionStatusId: [(this.subItems.perfectionStatusId).toString(), Validators.required],
            perfectionStatusReason: [(this.subItems.perfectionStatusReason).toString(), Validators.required],
        });    
...
// ------------------------end dynamic fields----------------------
    ...
    onCollateralTypeChange(id) { 
        ...
        switch(+id) {
            ...
            this.populateValueBaseType(this.collateralType);
                this.subForm = this.propertyForm;
