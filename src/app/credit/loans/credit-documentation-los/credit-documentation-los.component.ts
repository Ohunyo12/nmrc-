...
@Component({
    selector: 'app-credit-documentation-los',
    templateUrl: 'credit-documentation-los.component.html',
    styles: [`
    .remove-btn{
        color:#bbb;
        font-size:27px;
...
export class CreditDocumentationLosComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.getAvailedApplicationsForDocumentation();
        this.getRateCode();
        this.getCRMSRepaymentType();
        this.getBaseCurrency();
        this.getAllCurrencies();
        this.resetBeneficiaryForm();
        this.getAllDeferredDocument();
    ...
    printOverviewInformation(): void {
      ...
      this.camService.getAllDeferredDocument().subscribe((response) => {
    ...
    getAvailedApplicationsForDocumentation() {
        this.loadingSrv.show();
        this.loanBookingService.getAvailedApplicationsForDocumentation().subscribe((res) => {
    ...
    submitForm(form) { 
        this.searchString = form.value.searchString;
          ...
          this.subscriptions.add(
            this.loanBookingService.getAvailedApplicationsForDocumentationSearch(form.value.searchString).subscribe((response: any) => {
